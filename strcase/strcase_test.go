...
func (suite *StringCaseTestSuite) TestToSnakeCase() {
	...
	suite.Equal(strcase.ToSnakeCase("IDsCase"), "IDs_Case")
	suite.Equal(strcase.ToSnakeCase("CaseIDs"), "Case_IDs")
	suite.Equal(strcase.ToSnakeCase("CaseIDsThing"), "Case_IDs_Thing")
	suite.Equal(strcase.ToSnakeCase("ThingIDsCase"), "Thing_IDs_Case")
...
func (suite *StringCaseTestSuite) TestToSnakeCaseLower() {
	...
	suite.Equal(strcase.ToSnakeCaseLower("IDsCase"), "ids_case")
	suite.Equal(strcase.ToSnakeCaseLower("CaseIDs"), "case_ids")
	suite.Equal(strcase.ToSnakeCaseLower("CaseIDsThing"), "case_ids_thing")
	suite.Equal(strcase.ToSnakeCaseLower("ThingIDsCase"), "thing_ids_case")
...
func (suite *StringCaseTestSuite) TestToCamelCase() {
	...
	suite.Equal(strcase.ToCamelCase("IDs_Case"), "idsCase")
	suite.Equal(strcase.ToCamelCase("Case_IDs"), "caseIDs")
	suite.Equal(strcase.ToCamelCase("Case_IDs_Thing"), "caseIDsThing")
	suite.Equal(strcase.ToCamelCase("Thing_IDs_Case"), "thingIDsCase")
...
func (suite *StringCaseTestSuite) TestToKebabCase() {
	...
	suite.Equal(strcase.ToKebabCase("IDs_Case"), "IDs-Case")
	suite.Equal(strcase.ToKebabCase("Case_IDs"), "Case-IDs")
	suite.Equal(strcase.ToKebabCase("Case_IDs_Thing"), "Case-IDs-Thing")
	suite.Equal(strcase.ToKebabCase("Thing_IDs_Case"), "Thing-IDs-Case")
...
func (suite *StringCaseTestSuite) TestToKebabCaseLower() {
	...
	suite.Equal(strcase.ToKebabCaseLower("IDs_Case"), "ids-case")
	suite.Equal(strcase.ToKebabCaseLower("Case_IDs"), "case-ids")
	suite.Equal(strcase.ToKebabCaseLower("Case_IDs_Thing"), "case-ids-thing")
	suite.Equal(strcase.ToKebabCaseLower("Thing_IDs_Case"), "thing-ids-case")
